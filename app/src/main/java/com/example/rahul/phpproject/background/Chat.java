...
public class Chat extends AsyncTask<String, Void, ArrayList<JSONArray>> {
    ...
    public Chat(Context context, ChatInterface chatInterface) {
    ...
    protected ArrayList<JSONArray> doInBackground(String... voids) {
        ...
        String addUserUrl="http://192.168.43.92/phpProject/chat.php";
